...
<body>
  <div class="header">
    ...
    <p><strong>Report Date:</strong> ${new Date().toLocaleString('en-GB', { timeZone: 'Europe/Paris', weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: false })}</p>
  </div>
